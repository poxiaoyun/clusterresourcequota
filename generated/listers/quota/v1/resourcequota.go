...
type ResourceQuotaLister interface {
	...
	List(selector labels.Selector) (ret []*quotav1.ResourceQuota, err error)
...
type resourceQuotaLister struct {
	listers.ResourceIndexer[*quotav1.ResourceQuota]
}
...
func NewResourceQuotaLister(indexer cache.Indexer) ResourceQuotaLister {
	return &resourceQuotaLister{listers.New[*quotav1.ResourceQuota](indexer, quotav1.Resource("resourcequota"))}
}

// ResourceQuotas returns an object that can list and get ResourceQuotas.
func (s *resourceQuotaLister) ResourceQuotas(namespace string) ResourceQuotaNamespaceLister {
	return resourceQuotaNamespaceLister{listers.NewNamespaced[*quotav1.ResourceQuota](s.ResourceIndexer, namespace)}
}
...
type ResourceQuotaNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*quotav1.ResourceQuota, error)
