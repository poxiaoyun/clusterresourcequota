...
// QuotaV1Client is used to interact with features provided by the quota.xiaoshiai.cn group.
...
func (c *QuotaV1Client) ResourceQuotas(namespace string) ResourceQuotaInterface {
