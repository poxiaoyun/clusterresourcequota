...
import (
	...
	v1 "xiaoshiai.cn/clusterresourcequota/generated/clientset/versioned/typed/quota/v1"
)
...
func (c *FakeQuotaV1) ResourceQuotas(namespace string) v1.ResourceQuotaInterface {
